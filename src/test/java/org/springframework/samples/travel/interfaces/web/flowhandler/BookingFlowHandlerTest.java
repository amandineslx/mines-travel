...
public class BookingFlowHandlerTest {
    ...
    public void shouldReturnCorrectPathWhenHandlingExecutionOutcome() {
        assertThat(
                flowHandler.handleExecutionOutcome(Mockito.any(FlowExecutionOutcome.class),
                        Mockito.any(HttpServletRequest.class), Mockito.any(HttpServletResponse.class))).isEqualTo(
    ...
    public void shouldHandleNoSuchFlowExecutionException() {
        ...
        assertThat(
                flowHandler.handleException(noSuchFlowExecutionException, Mockito.any(HttpServletRequest.class),
                        Mockito.any(HttpServletResponse.class))).isEqualTo(EXPECTED_REDIRECT_URL);
    }

    @Test(expected = FlowBuilderException.class)
    public void shouldReThrowExceptionOtherThanNoSuchFlowExecutionException() {
        flowHandler.handleException(new FlowBuilderException(null), Mockito.any(HttpServletRequest.class),
